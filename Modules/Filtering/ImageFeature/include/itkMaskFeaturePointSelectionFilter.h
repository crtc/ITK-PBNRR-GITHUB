...
public:
  ...
  /** bool flag to enable/disable computing tensors */
  itkSetMacro(ComputeTensors, bool);
  itkGetConstReferenceMacro(ComputeTensors, bool);
  itkBooleanMacro(ComputeTensors);
